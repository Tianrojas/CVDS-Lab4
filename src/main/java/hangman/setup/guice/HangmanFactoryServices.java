...
public class HangmanFactoryServices extends com.google.inject.AbstractModule {
    ...
    protected void configure() {
    	...
    	MapBinder<LanguageOption, Language> mapBinderLanguage 
		= MapBinder.newMapBinder(binder(), LanguageOption.class, Language.class);
    	...
    	MapBinder<dictionaryOption, HangmanDictionary> mapBinderDictionary 
		= MapBinder.newMapBinder(binder(), dictionaryOption.class, HangmanDictionary.class);
    	
    	mapBinderDictionary.addBinding(dictionaryOption.EnglishDictionaryDataSource).to(EnglishDictionaryDataSource.class);
    	mapBinderDictionary.addBinding(dictionaryOption.FrenchDictionaryDataSource).to(FrenchDictionaryDataSource.class);
    	mapBinderDictionary.addBinding(dictionaryOption.SpanishDictionaryDataSource).to(SpanishDictionaryDataSource.class);
    	
    	MapBinder<panelOption, HangmanPanel> mapBinderPanel 
		= MapBinder.newMapBinder(binder(), panelOption.class, HangmanPanel.class);
